...
Previously, specialty bed costs from Public Health Scotland have been utilised for the models (Table \ref{tab:PHSCostsPerSpecialty2}). %These variables will be extended to provide a cost for every specialty in every hospital.
